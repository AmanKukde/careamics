...
class WindowedTilingGridIndexManager(GridIndexManager):
    ...
    def __post_init__(self):
        ...
        print(f"{self.__class__.__name__} initialized with padded_data_shape: {self.padded_data_shape},")
        print(f"{self.__class__.__name__} initialized with patch_shape: {self.patch_shape}, stride: {self.stride}")
